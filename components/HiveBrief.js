    ...
    <section id="brief" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden" style={{ background: 'radial-gradient(ellipse at 85% 20%, rgba(0,245,255,0.11), transparent 36%), linear-gradient(180deg, #050A18, #0A1628)' }}>
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <p className="eyebrow justify-center"><BulbIcon size={16} /> HIVE BRIEF</p>
          <h2 className="section-title mt-5">Have the idea. <span className="gradient-text">We’ll find the shape.</span></h2>
        ...
        <div className="brief-shell grid lg:grid-cols-[1.15fr_0.85fr] gap-0 overflow-hidden">
          <div className="p-6 sm:p-9 border-b lg:border-b-0 lg:border-r border-yellow-300/10">
            ...
            <label className="text-sm font-semibold text-white block mt-8 mb-3" htmlFor="idea">Tell the bees the rough idea</label>
          ...
          <aside className="p-6 sm:p-9 bg-[#07142a]/70">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mt-2">A starting signal, not a quote. We’ll shape scope honestly around what is worth building.</p>
            ...
            <div className="mt-10 p-5 rounded-2xl border border-cyan-300/15 bg-cyan-300/[0.04]"><div className="flex gap-3"><BeeIcon size={24} /><div><p className="font-bold text-white">Your route to the hive</p><p className="text-sm text-gray-400 mt-1">You choose the starting point. I’ll respond with realistic next steps.</p></div></div></div>
