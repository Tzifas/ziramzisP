...
import { ArrowRightIcon, BeeIcon, BulbIcon } from './Icons';
    ...
    <section id="colony" className="idea-hive py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-[0.88fr_1.12fr] gap-9 lg:gap-16 items-center">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          <p className="eyebrow"><BeeIcon size={16} /> <span style={{ color: 'var(--cyan-mid)' }}>THE IDEA INTAKE</span></p>
          <h2 className="section-title mt-5">Bring the spark. <span className="gradient-text">I’ll help it take shape.</span></h2>
          ...
          <div className="bee-console mt-8 sm:mt-10" aria-hidden="true"><div className="bee-console__rings" /><div className="bee-console__spark bee-console__spark--one" /><div className="bee-console__spark bee-console__spark--two" /><div className="bee-console__entrance"><NoteBee size={116} /></div><span className="bee-console__label">IDEA INTAKE</span><span className="bee-console__hint" style={{ position: 'absolute', right: '1.25rem', bottom: '1rem', display: 'inline-flex', alignItems: 'center', gap: '.35rem', color: '#F5C842', fontSize: '.6rem', fontWeight: 800, letterSpacing: '.22em' }}><BulbIcon size={13} color="#F5C842" /> PRESS</span></div>
        </motion.div>
