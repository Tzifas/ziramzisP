...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark-card border-t border-white/10 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 pb-16 border-b border-white/10">
          <h3 className="text-3xl font-semibold mb-2">Stay updated</h3>
          <p className="text-gray-400 mb-6">Receive project updates, design tips, and launch announcements.</p>
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-xl">
            <input
              ...
              required
              className="flex-1 px-4 py-3 rounded-2xl bg-dark border border-white/10 focus:border-primary outline-none transition text-white"
            />
            <button type="submit" className="gradient-button px-6 py-3 rounded-2xl font-semibold text-black whitespace-nowrap">
              Subscribe
            </button>
          </form>
          {subscribeMessage && <p className="text-accent mt-3 text-sm">{subscribeMessage}</p>}
        </div>

        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-primary to-secondary text-white flex items-center justify-center font-bold">
                Z
              </div>
              <div>
                <p className="text-sm uppercase tracking-[0.25em] text-gray-400">Ziramzis</p>
                <p className="font-semibold">Digital Creator</p>
              </div>
            </div>
            <p className="text-gray-400 text-sm">Building vibrant digital products, portfolios, and web apps for businesses that want to feel alive online.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li>
                <a href="mailto:hello@ziramzis.app" className="hover:text-primary transition">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-11 h-11 rounded-2xl bg-dark border border-white/10 flex items-center justify-center hover:border-primary hover:text-primary transition">
